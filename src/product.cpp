...
{
    double product_loading_time = UniformDistribution::Generate(PRODUCT_LOADING_TIME_AVG, PRODUCT_LOADING_TIME_DEVIATION);
    ...
    double product_machining_time = UniformDistribution::Generate(PRODUCT_MACHINING_TIME_AVG, PRODUCT_MACHINING_TIME_DEVIATION);
    ...
    double product_preparation_for_milling = UniformDistribution::Generate(PRODUCT_PREPARING_FOR_MILLING_TIME_AVG, PRODUCT_PREPARING_FOR_MILLING_TIME_DEVIATION);
    ...
    double product_milling_time = UniformDistribution::Generate(PRODUCT_MILLING_TIME_AVG, PRODUCT_MILLING_TIME_DEVIATION);
    ...
    if (Random() < 0.90)
    {
        double finalizing_time = UniformDistribution::Generate(PRODUCT_FINALIZING_CORRECT_TIME_AVG, PRODUCT_FINALIZING_CORRECT_TIME_DEVIATION);
        (*product_finalizing_time_stats)(finalizing_time);
        Wait(finalizing_time);
    }
    else
    {
        double finalizing_time = UniformDistribution::Generate(PRODUCT_FINALIZING_BAD_TIME_AVG, PRODUCT_FINALIZING_BAD_TIME_DEVIATION);
        (*product_finalizing_time_stats)(finalizing_time);
        Wait(finalizing_time);
    }
